...
@interface FoodMapViewController ()<UIWebViewDelegate,UIAlertViewDelegate,CLLocationManagerDelegate>
{
...
-(void)dealloc
{
    ...
    NSUInteger dist = [NSURLCache sharedURLCache].currentDiskUsage;
    NSUInteger memery = [NSURLCache sharedURLCache].currentMemoryUsage;
    NSLog(@"%ld, mem = %ld", dist, memery);
    
     [[NSURLCache sharedURLCache] removeAllCachedResponses];
    
    dist = [NSURLCache sharedURLCache].currentDiskUsage;
    memery = [NSURLCache sharedURLCache].currentMemoryUsage;
    NSLog(@"%ld, mem = %ld", dist, memery);
    
    [_foodWedView removeFromSuperview];
    
    [_locationManager release];
    [_foodWedView stopLoading];
    _foodWedView.delegate = nil;
